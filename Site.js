...
class Site {
	...
	constructor(x, y) {
		...
		this.y = y;
		this.displacements = {
			c: new Displacement(2/3, new p5.Vector(0, 0)),
			//n: new Displacement(1/9, new p5.Vector(0, -1)),
			e: new Displacement(1/6, new p5.Vector(1, 0)),
			//s: new Displacement(1/9, new p5.Vector(0, 1)),
			w: new Displacement(1/6, new p5.Vector(-1, 0)),
	...
	macroFlow = () => {
		return new p5.Vector(this.macroXVelocity(), 0);
	}
	...
	collide = () => {
		...
		this.velocity = new p5.Vector(this.macroXVelocity(), 0);
		Object.values(this.displacements).forEach((d) => {
